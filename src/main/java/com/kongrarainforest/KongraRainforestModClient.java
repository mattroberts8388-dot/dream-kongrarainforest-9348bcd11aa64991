...
public class KongraRainforestModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        EntityRendererRegistry.register(KongraRainforestEntities.KONGRA, NoopRenderer::new);
        EntityRendererRegistry.register(KongraRainforestEntities.TOUCAN, NoopRenderer::new);
        EntityRendererRegistry.register(KongraRainforestEntities.JAGUAR, NoopRenderer::new);
    }
